...
/**
 * SkinTemplate class for Mylib skin
 * @ingroup Skins
 */
class SkinMylib extends SkinTemplate {

	var $skinname = 'mylib', $stylename = 'mylib',
		$template = 'MylibTemplate', $useHeadElement = true;
	...
	public function initPage( OutputPage $out ) {
		...
		$out->addModuleScripts( 'skins.mylib' );
	}
	...
	function setupSkinUserCss( OutputPage $out ){
		...
		$out->addModuleStyles( 'skins.mylib' );
	}
}

/**
 * QuickTemplate class for Mylib skin
 * @ingroup Skins
 */
class MylibTemplate extends BaseTemplate {
...
?>
	<div id="project-links">
		<ul>
			...
			<li id="project-wiki" class="current"><a href="//wiki.chitanka.info">Уики</a></li>
	...
	<div style="position: relative">
		...
		<!-- panel -->
			<div id="mw-panel" class="noprint">
				<!-- logo -->
					<div id="p-logo"><a style="background-image: url(<?php $this->text( 'logopath' ) ?>);" href="<?php echo htmlspecialchars( $this->data['nav_urls']['mainpage']['href'] ) ?>"></a></div>
				<!-- /logo -->
